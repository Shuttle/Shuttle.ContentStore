...
namespace Shuttle.ContentStore
{
    ...
    {
        public static readonly MappedColumn<byte[]> Bytes = new MappedColumn<byte[]>("Bytes", DbType.Binary);
        ...
        public static MappedColumn<Guid> ContentId = new MappedColumn<Guid>("ContentId", DbType.Guid);
        ...
        public static readonly MappedColumn<byte[]> SanitizedBytes = new MappedColumn<byte[]>("SanitizedBytes", DbType.Binary);
